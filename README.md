...
Também é interessante utilizar captchas para impedir que um script de brute force rode ou DoS rode livremente, após algumas tentativas o captcha seria acionado e o script não conseguiria continuar rodando. 
